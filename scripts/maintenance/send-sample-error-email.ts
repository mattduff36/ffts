...
async function sendSampleEmail() {
  ...
  const sampleErrors = [
    ...
    { id: '3', timestamp: new Date(yesterday.setHours(10, 45, 12)).toISOString(), error_type: 'Error', error_message: 'Failed to fetch inspection data', component_name: 'Inspections Page', page_url: 'https://your-app.example.com/van-inspections/abc-123', user_email: 'employee@example.com' },
