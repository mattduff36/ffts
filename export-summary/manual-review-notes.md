...
- `supabase/migrations/` was preserved as the reusable product architecture. If selling this as a fresh starter, consider adding a clean baseline migration path for new installs.
