...
export const QUOTE_EMAIL_TEMPLATE_DEFINITIONS: QuoteEmailTemplateDefinition[] = [
  {
    ...
    sample_context: {
      ...
      quote_name: '40001-GH - MPDEE TEST CUSTOMER - 1 Roadname Lane - Concrete Bund Wall Repairs',
      contact_name: 'Matt Duffill',
      customer_name: 'MPDEE TEST CUSTOMER',
